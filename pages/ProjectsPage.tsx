...
import {  ArrowUpRight, ArrowRight, MousePointer2, Layout, Maximize2, MapPin, Calendar, Ruler } from 'lucide-react';
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-20">
                        {filteredProjects.map((project, index) => (
                             ...
                             >
                                ...
                                {/* Card Container */}
                                <Link to={`/projects/${project.id}`} className="relative z-10 block overflow-hidden rounded-sm cursor-pointer">
                                    {/* Image */}
