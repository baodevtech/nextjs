...
export const BlogDetailPage: React.FC = () => {
  ...
  const articleSchema = {
    ...
    "headline": post.title,
    "image": [post.image],
    "datePublished": post.date, // Best if ISO format, but strings work loosely
    ...
    "publisher": {
      ...
      "logo": {
        "@type": "ImageObject",
        "url": "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?q=80&w=200" // Mock Logo URL
      }
    },
  ...
  return (
    <div className="bg-white min-h-screen font-sans animate-fade-in pb-20">
        ...
        {/* 1. CLEAN HEADER (Not Fullscreen Hero) */}
                ...
                <main className="lg:w-3/4">
                    ...
                    <div className="mt-16">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {relatedPosts.map(p => (
                                <Link key={p.id} to={`/blog/${p.slug}`} className="group flex gap-4 bg-gray-50 p-4 rounded-xl border border-gray-100 hover:border-brand-200 transition-all">
                ...
                <aside className="lg:w-1/4 space-y-8">
                    ...
                    <div className="sticky top-28 bg-slate-50 p-6 rounded-2xl border border-gray-200">
                        ...
                        <nav className="space-y-1">
                            {/* Mock TOC - In a real app, parse this from content */}
