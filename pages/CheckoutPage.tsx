...
import { ArrowLeft, Trash2, Send, CheckCircle, ShieldCheck, Phone, MapPin } from 'lucide-react';
...
export const CheckoutPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setIsSuccess(true);
        // Here you would clear the cart in a real app
    };
        ...
        <div className="min-h-screen bg-slate-50 py-12 font-sans animate-fade-in">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-2 mb-8">
                    <Link to="/shop" className="text-slate-500 hover:text-brand-600 transition-colors flex items-center gap-1 text-sm font-bold uppercase tracking-wider">
