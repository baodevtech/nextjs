                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-12 animate-fade-in">
                        ...
                        {results.products.length > 0 ? (
                            <div className="space-y-4">
                                {results.products.map(p => (
                                    <Link key={p.id} to={`/product/${p.slug}`} onClick={onClose} className="flex gap-4 group p-3 rounded-xl hover:bg-gray-50 transition-colors">
                                ...
                                <Link to={`/shop?search=${query}`} onClick={onClose} className="inline-flex items-center gap-2 text-sm font-bold text-brand-600 hover:underline mt-2 px-3">
                     ...
                     <div>
                        ...
                        {results.blogs.length > 0 ? (
                            <div className="space-y-4">
                                {results.blogs.map(b => (
                                    <Link key={b.id} to={`/blog/${b.slug}`} onClick={onClose} className="block group p-3 rounded-xl hover:bg-gray-50 transition-colors">
