...
// --- ICON MAPPING ---
// Map từ string (lưu trong DB) sang Component Icon
                ...
                {space.hotspots.map((spot, idx) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {/* Popover Card */}
                            <div className={`
                                absolute left-full ml-4 top-1/2 -translate-y-1/2 w-64 bg-white/95 backdrop-blur-xl rounded-2xl p-5 shadow-2xl border border-white/50 origin-left transition-all duration-300 z-50
...
const BeforeAfterSlider = ({ beforeImage, afterImage }: { beforeImage: string, afterImage: string }) => {
    ...
    return (
        <div 
            ref={containerRef}
            className="relative w-full aspect-video md:aspect-[21/9] rounded-3xl overflow-hidden cursor-ew-resize select-none shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5)] border border-white/10 group bg-slate-800"
        ...
        <div className="bg-slate-950 font-sans text-slate-200 animate-fade-in">
            ...
            <section className="relative h-screen flex flex-col justify-center items-center overflow-hidden">
                <div className="absolute inset-0 opacity-40">
                    {/* Dùng ảnh đầu tiên của Space làm nền Hero nếu không có ảnh riêng */}
                    <img 
            ...
            <section className="py-32 bg-slate-900 relative overflow-hidden">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-amber-900/20 rounded-full blur-[120px] pointer-events-none"></div>
