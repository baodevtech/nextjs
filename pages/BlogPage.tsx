                    ...
                    <div className="space-y-12">
                        {filteredPosts.map(post => (
                            <article key={post.id} className="flex flex-col group border-b border-gray-100 pb-12 last:border-0 last:pb-0">
                                {/* Image */}
                                <Link to={`/blog/${post.slug}`} className="block overflow-hidden rounded-2xl aspect-[16/9] mb-6 shadow-sm">
                                     <img 
                                        src={post.image} 
                                        alt={post.title} 
                                ...
                                {/* Content */}
                                <Link to={`/blog/${post.slug}`} className="group-hover:text-brand-700 transition-colors">
                                ...
                                <div className="flex items-center justify-between mt-auto">
                                    ...
                                    <Link to={`/blog/${post.slug}`} className="flex items-center gap-2 text-sm font-bold text-brand-600 hover:text-brand-800 transition-colors">
