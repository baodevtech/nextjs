...
import { ArrowLeft, ArrowRight, MapPin, Calendar, Ruler, Layout, CheckCircle2, Quote, X, ChevronLeft, ChevronRight, ZoomIn, Grid } from 'lucide-react';
...
export const ProjectDetailPage: React.FC = () => {
    ...
    useEffect(() => {
        window.scrollTo(0, 0);
        const data = PROJECT_DETAILS[id || ""] || PROJECT_DETAILS["default"];
        setProject(data);
    }, [id]);
    ...
    const nextProjectId = (parseInt(id || "1") + 1).toString();
        ...
        <div className="bg-slate-950 font-sans text-slate-200 animate-fade-in selection:bg-amber-500 selection:text-white">
            ...
            <section className="relative h-screen w-full overflow-hidden">
                ...
                <div className="absolute top-8 left-8 z-20">
                     <Link to="/projects" className="flex items-center gap-2 text-white/70 hover:text-amber-400 transition-colors uppercase text-xs font-bold tracking-widest group">
            ...
            <section className="py-32 bg-slate-900 relative overflow-hidden group cursor-pointer" onClick={() => navigate(`/projects/${nextProjectId}`)}>
