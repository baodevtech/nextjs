          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-6 md:h-[500px]">
                  ...
                  <div className="col-span-2 md:row-span-2 bg-slate-50 rounded-2xl md:rounded-3xl p-5 md:p-12 relative overflow-hidden group hover:shadow-xl transition-all duration-500 min-h-[220px] md:min-h-0">
                      ...
                      <div className="absolute top-0 right-0 w-[200px] h-[200px] md:w-[400px] md:h-[400px] bg-blue-100 rounded-full blur-[60px] md:blur-[100px] -mr-20 -mt-20 md:-mr-32 md:-mt-32 transition-all group-hover:bg-blue-200 z-0"></div>
                      ...
                      <div className="relative z-10 h-full flex flex-col justify-between">
                              ...
                              <div className="w-10 h-10 md:w-12 md:h-12 bg-white rounded-xl md:rounded-2xl flex items-center justify-center shadow-sm mb-3 md:mb-6 text-blue-600">
                                  {largeCard.icon ? (
                                      <div className="relative w-5 h-5 md:w-6 md:h-6">
                                          <Image src={largeCard.icon} alt="Icon" fill className="object-contain" sizes="24px" />
                                      </div>
                                  ) : (
                          ...
                          <div className="mt-4 md:mt-8 flex flex-wrap gap-2">
                              {largeCard.tags.map((tag, idx) => (
                                  <span key={idx} className="px-2.5 py-1 md:px-4 md:py-2 bg-white rounded-full text-[10px] md:text-xs font-bold text-slate-700 shadow-sm border border-slate-100 relative z-10">
                                      {tag.text}
                                  </span>
                              ))}
                          </div>
                      ...
                      {/* Illustration Image: Căn phải, dưới, kích thước bung to */}
                      {largeCard.image && (
                          <div className="absolute bottom-0 right-0 w-[140px] md:w-[55%] h-[80%] md:h-[100%] p-2 md:p-6 transition-transform duration-700 pointer-events-none z-0">
                              <Image 
                                  src={largeCard.image} 
                                  alt="Structure Layer" 
                                  fill
                          ...
                          <div className="mb-2 md:mb-4">
                              {smallCards[0].icon ? (
                                  <div className="relative w-8 h-8 md:w-10 md:h-10">
                                      <Image src={smallCards[0].icon} alt="Icon" fill className="object-contain" sizes="40px" />
                                  </div>
                              ) : (
                  ...
                  {smallCards[1] && (
                      <div className="col-span-1 bg-slate-50 rounded-2xl md:rounded-3xl p-4 md:p-8 relative overflow-hidden group hover:bg-green-50 transition-colors duration-300 flex flex-col justify-center min-h-[140px] md:min-h-0">
                          <div className="mb-2 md:mb-4">
                              {smallCards[1].icon ? (
                                  <div className="relative w-8 h-8 md:w-10 md:h-10">
                                      <Image src={smallCards[1].icon} alt="Icon" fill className="object-contain" sizes="40px" />
                                  </div>
                              ) : (
