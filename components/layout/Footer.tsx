    ...
    <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
      ...
      <div>
        ...
        <ul className="space-y-3 text-sm">
          <li><Link to="/shop?cat=lam-song" className="hover:text-brand-400 transition-colors flex items-center gap-2"><span className="w-1 h-1 bg-brand-500 rounded-full"></span>Tấm ốp Lam Sóng</Link></li>
          <li><Link to="/shop?cat=nano" className="hover:text-brand-400 transition-colors flex items-center gap-2"><span className="w-1 h-1 bg-brand-500 rounded-full"></span>Tấm ốp Nano</Link></li>
          <li><Link to="/shop?cat=pvc-stone" className="hover:text-brand-400 transition-colors flex items-center gap-2"><span className="w-1 h-1 bg-brand-500 rounded-full"></span>PVC Vân Đá</Link></li>
          <li><Link to="/shop?cat=accessories" className="hover:text-brand-400 transition-colors flex items-center gap-2"><span className="w-1 h-1 bg-brand-500 rounded-full"></span>Phụ Kiện Thi Công</Link></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-3 text-sm">
          <li><Link to="/policy" className="hover:text-brand-400 transition-colors">Chính sách bảo hành 15 năm</Link></li>
          <li><Link to="/shipping" className="hover:text-brand-400 transition-colors">Vận chuyển & Thanh toán</Link></li>
          <li><Link to="/guide" className="hover:text-brand-400 transition-colors">Hướng dẫn thi công</Link></li>
